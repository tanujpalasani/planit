...
- `https://planit-six-kappa.vercel.app/` (Frontend)
...
## 7) Submission Snapshot Template

Use this section while submitting:

- Name: `<YOUR_NAME>`
- Roll Number: `<YOUR_ROLL_NUMBER>`
- GitHub Repository: `https://github.com/tanujpalasani/planit`
- Deployed Backend URL: `https://planit-backend-5qgs.onrender.com`
- Deployed Frontend URL: `https://planit-six-kappa.vercel.app/`

Screenshot placeholders:
- Running Containers (Docker Desktop): `<ADD_SCREENSHOT>`
- Working Application - Home: `<ADD_SCREENSHOT>`
- Working Application - Auth/Dashboard: `<ADD_SCREENSHOT>`
- Backend Health (`/api/health`): `<ADD_SCREENSHOT>`
